...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('daily_sales', function (Blueprint $table) {
            $table->unsignedInteger('delivery_sales_count')->default(0)->after('amount');
    ...
    {
        Schema::table('daily_sales', function (Blueprint $table) {
            $table->dropColumn(['delivery_sales_count', 'delivery_revenue', 'counter_sales_count', 'counter_revenue']);
        });
    }
};
